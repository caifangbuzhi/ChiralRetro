...
def get_batch_graphs(graph_batch: List[MolGraph], use_rxn_class: bool = False) -> Tuple[torch.Tensor, List[Tuple[int]]]:
    ...
    for mol_graph in graph_batch:
        ...
        for b in range(mol_graph.n_bonds):  
            ...
            a_in, a_out = mol_graph.directed_b2a[b]
            directed_b2a.append([n_atoms+a_in, n_atoms+a_out])
    ...
    parity_atoms = torch.LongTensor(parity_atoms)
    ...
    directed_b2a = create_pad_tensor(directed_b2a)

    graph_tensors = (f_atoms, f_bonds, a2b, b2a, b2revb, undirected_b2a, directed_b2a)
    scopes = (a_scope, b_scope)

    return graph_tensors, scopes, parity_atoms
